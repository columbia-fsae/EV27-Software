...
void printInputs(int sdc, int bms, int imd, int bpt_oc, int bpt_sc, int ct_oc, int ct_sc, int bspd,
                 int dual) {
    ...
    Serial.println(digitalRead(BMS_DASH_LED) ? "\t\tReceived BMS_DASH_LED: 5V"
                                             : "\t\tReceived BMS_DASH_LED: 0V");
    ...
    Serial.println(digitalRead(IMD_DASH_LED) ? "\t\tReceived IMD_DASH_LED: 5V"
                                             : "\t\tReceived IMD_DASH_LED: 0V");
    ...
    Serial.println(digitalRead(BPT_OC_OK) ? "\tReceived BPT_OC_OK: 5V"
                                          : "\tReceived BPT_OC_OK: 0V");
    ...
    Serial.println(digitalRead(BPT_SC_OK) ? "\tReceived BPT_SC_OK: 5V"
                                          : "\tReceived BPT_SC_OK: 0V");
    ...
    Serial.println(digitalRead(BSPD_DASH_LED) ? "\tReceived BSPD_DASH_LED: 5V"
                                              : "\tReceived BSPD_DASH_LED: 0V");

    Serial.print(F("Expected DUAL_OK: "));
    Serial.print(dual);
    Serial.print(F("V"));
    Serial.println(digitalRead(DUAL_OK) ? "\t\t\t\tReceived DUAL_OK: 5V"
                                        : "\t\t\t\tReceived DUAL_OK: 0V");
}
...
void bmsTest() {
    ...
    delay(500);
    if (digitalRead(SDC_OUT) == 1 || digitalRead(BMS_DASH_LED) == 0 ||

        digitalRead(IMD_DASH_LED) == 1 || digitalRead(DUAL_OK) == 0 ||
        digitalRead(BSPD_DASH_LED) == 1 || digitalRead(BPT_SC_OK) == 0 ||
        digitalRead(BPT_OC_OK) == 0 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 0) {
        passed = false;
    ...
    digitalWrite(BMS, HIGH);  // 24V
    delay(500);
    if (digitalRead(BMS_DASH_LED) == 0 || digitalRead(SDC_OUT) == 1 ||
    ...
    reset();
    if (digitalRead(BMS_DASH_LED) == 1 || digitalRead(SDC_OUT) == 0 ||
...
void imdTest() {
    ...
    delay(500);
    if (digitalRead(IMD_DASH_LED) == 0 || digitalRead(SDC_OUT) == 1 ||

        digitalRead(BMS_DASH_LED) == 1 || digitalRead(DUAL_OK) == 0 ||
        digitalRead(BSPD_DASH_LED) == 1 || digitalRead(BPT_SC_OK) == 0 ||
        digitalRead(BPT_OC_OK) == 0 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 0) {
        passed = false;
    ...
    reset();
    if (digitalRead(IMD_DASH_LED) == 1 || digitalRead(SDC_OUT) == 0 ||
...
void bptTest() {
    ...
    setVoltage(0, 2.0);
    delay(500);
    if (digitalRead(SDC_OUT) == 1 || digitalRead(BPT_SC_OK) == 0 || digitalRead(BPT_OC_OK) == 1 ||
        digitalRead(BSPD_DASH_LED) == 0 ||

        digitalRead(BMS_DASH_LED) == 1 || digitalRead(IMD_DASH_LED) == 1 ||
        digitalRead(DUAL_OK) == 0 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 0) {
        passed = false;
    ...
    setVoltage(2.0, 2.0);
    delay(500);
    if (digitalRead(SDC_OUT) == 1 || digitalRead(BPT_SC_OK) == 0 || digitalRead(BPT_OC_OK) == 0 ||
        digitalRead(BSPD_DASH_LED) == 0 ||
    ...
    reset();
    if (digitalRead(SDC_OUT) == 0 || digitalRead(BPT_SC_OK) == 0 || digitalRead(BPT_OC_OK) == 0 ||
...
void ctTest() {
    ...
    setVoltage(2.0, 0);
    delay(500);
    if (digitalRead(SDC_OUT) == 1 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 1 ||
        digitalRead(BSPD_DASH_LED) == 0 ||

        digitalRead(BMS_DASH_LED) == 1 || digitalRead(IMD_DASH_LED) == 1 ||
        digitalRead(DUAL_OK) == 0 || digitalRead(BPT_SC_OK) == 0 || digitalRead(BPT_OC_OK) == 0) {
        passed = false;
    ...
    setVoltage(2.0, 2.0);
    delay(500);
    if (digitalRead(SDC_OUT) == 1 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 0 ||
        digitalRead(BSPD_DASH_LED) == 0 ||
    ...
    reset();
    if (digitalRead(SDC_OUT) == 0 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 0 ||
        digitalRead(BSPD_DASH_LED) == 1 ||
...
void dualTest() {
    ...
    setVoltage(3.55, 2.0);
    delay(500);
    if (digitalRead(SDC_OUT) == 0 || digitalRead(DUAL_OK) == 0 || digitalRead(BSPD_DASH_LED) == 1 ||
        digitalRead(BPT_SC_OK) == 0 || digitalRead(BPT_OC_OK) == 0 || digitalRead(CT_SC_OK) == 0 ||
    ...
    setVoltage(3.55, 2.8);
    delay(500);
    if (digitalRead(SDC_OUT) == 1 || digitalRead(DUAL_OK) == 1 || digitalRead(BSPD_DASH_LED) == 0 ||
        digitalRead(BPT_SC_OK) == 0 || digitalRead(BPT_OC_OK) == 0 || digitalRead(CT_SC_OK) == 0 ||
        digitalRead(CT_OC_OK) == 0 ||
    ...
    setVoltage(2.0, 2.0);
    delay(500);
    if (digitalRead(SDC_OUT) == 1 || digitalRead(DUAL_OK) == 0 || digitalRead(BSPD_DASH_LED) == 0 ||
        digitalRead(BPT_SC_OK) == 0 || digitalRead(BPT_OC_OK) == 0 || digitalRead(CT_SC_OK) == 0 ||
        digitalRead(CT_OC_OK) == 0 ||
