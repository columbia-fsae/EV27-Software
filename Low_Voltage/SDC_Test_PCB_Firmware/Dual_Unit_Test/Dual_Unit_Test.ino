...
void setup() {
    ...
    if (digitalRead(DUAL_OK) == 0 || digitalRead(SDC_OUT) == 0 || digitalRead(BPT_SC_OK) == 0 ||
    ...
    if (digitalRead(DUAL_OK) == 1 || digitalRead(SDC_OUT) == 1 || digitalRead(BPT_SC_OK) == 0 ||
        digitalRead(BPT_OC_OK) == 0 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 0) {
        passed = false;
    }
    Serial.print(digitalRead(DUAL_OK) ? "Recieved DUAL_OK: 5V, " : "Recieved DUAL_OK: 0V, ");
    ...
    if (digitalRead(DUAL_OK) == 0 || digitalRead(SDC_OUT) == 1 || digitalRead(BPT_SC_OK) == 0 ||
        digitalRead(BPT_OC_OK) == 0 || digitalRead(CT_SC_OK) == 0 || digitalRead(CT_OC_OK) == 0) {
        passed = false;
    }
    Serial.print(digitalRead(DUAL_OK) ? "Recieved DUAL_OK: 5V, " : "Recieved DUAL_OK: 0V, ");
