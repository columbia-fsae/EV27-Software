...
def main():
    ...
    print(
        f"[Accel]    peak electric power = {accel.stats.pelectric.max() / 1e3:.1f} kW, "
    ...
    print(
        f"[Endur]    peak electric power = {endur.stats.pelectric.max() / 1e3:.1f} kW, "
    ...
    print(
        f"[Endur]    22-lap time = {endur_time:.1f} s, avg electric power = "
