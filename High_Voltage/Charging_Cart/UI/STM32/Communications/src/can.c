...
// output in mV
uint16_t cell_voltage_conversion(uint8_t raw_value) { return ((uint16_t)raw_value) * 10 + 1800; }

// output in 0.01C
uint16_t cell_temperature_conversion(int8_t raw_value) { return ((uint16_t)raw_value) * 25; }

// output in percentage
uint16_t cell_soc_conversion(uint8_t raw_value) { return ((uint16_t)raw_value * 100) / 255; }

// output in 0.1V
uint16_t pack_voltage_conversion(uint16_t raw_value) { return raw_value / 10; }
