...
#define osMutexDef(name)                                                                   \
    ...
    const osMutexDef_t os_mutex_def_##name = {NULL, osMutexRecursive | osMutexPrioInherit, \
                                              (&os_mutex_cb_##name), sizeof(StaticSemaphore_t)}
#endif
...
#define osSemaphoreDef(name)                                                               \
    ...
    const osSemaphoreDef_t os_semaphore_def_##name = {NULL, 0U, (&os_semaphore_cb_##name), \
...
#define osMessageQDef(name, queue_sz, type)                                         \
    ...
    const osMessageQDef_t os_messageQ_def_##name = {                                \
        (queue_sz),                                                                 \
        {NULL, 0U, (&os_mq_cb_##name), sizeof(StaticQueue_t), (&os_mq_data_##name), \
         sizeof(os_mq_data_##name)}}
#endif
